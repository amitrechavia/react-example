...
c = pymongo.MongoClient(
    "mongodb+srv://barbot:barbot122@barbot.ury12.mongodb.net/barbot?retryWrites=true&w=majority", serverSelectionTimeoutMS=5000,tlsAllowInvalidCertificates=True)
db = c.barbot
